 ...
 */
class GouraudTextureMaterial extends Material {
	constructor(gl, config) {
		super(gl, config, 'gouraudtexture')
	...
	bind(mesh, transform, camera, light) {
		...
		//console.log('lightPosEC ', lightPositionEC);
		...
		this.program.setTexture('uTexture', 0, this.config.texture)
	}
...
export default GouraudTextureMaterial
